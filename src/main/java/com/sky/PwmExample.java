...
public class PwmExample {
     ...
     * @param args
     */
    public void runPWM(String[] args) throws InterruptedException {
        ...
        Pin pin = CommandArgumentParser.getPin(
                ...
                RaspiBcmPin.GPIO_19,  // default pin if no pin argument found
                args);             // argument array to search in

        System.out.println(pin.getSupportedPinModes());
        ...
        pwm.setPwm(1000);
        console.println("PWM rate : " + pwm.getPwm());
        Thread.sleep(5000);
